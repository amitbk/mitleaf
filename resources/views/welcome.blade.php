...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>WooLanding | Landing, Corporate &amp; Business Templatee</title>
  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <div class="container-fluid"><a class="navbar-brand" href="#"><img src="assets/img/icons/logo.png" alt="" width="169" /></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto ms-lg-4 ms-xl-7 border-bottom border-lg-bottom-0 pt-2 pt-lg-0">
              <li class="nav-item"><a class="nav-link fw-medium active" aria-current="page" href="#">Welcome</a></li>
              <li class="nav-item"><a class="nav-link fw-medium" href="#">Features</a></li>
              <li class="nav-item"><a class="nav-link fw-medium" href="#">Success Stories</a></li>
              <li class="nav-item"><a class="nav-link fw-medium" href="#">Pricing</a></li>
              <li class="nav-item"><a class="nav-link fw-medium" href="#">Start your business</a></li>
            </ul>
            <form class="d-flex py-3 py-lg-0">
              <a class="btn btn-link text-1000 fw-medium order-1 order-lg-0 me-lg-2" href="{{url('login')}}" role="button">Log In</a>
              <a class="btn btn-info order-0 me-1" href="{{url('register')}}" role="button">Get Started</a>
      ...
      <section class="py-0 bg-light-gradient">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-5 order-md-1 pt-8"><img class="img-fluid" src="assets/img/gallery/hero.png" alt="" /></div>
            <div class="col-md-7 col-lg-6 text-center text-md-start pt-5 pt-md-9">
              <h1 class="display-2 fw-bold fs-4 fs-md-5 fs-xl-6">Get Attention On <br> Social Media  & Build A Brand Awareness</h1>
              <p class="mt-3 mb-4">Social Media is Essential part for your business, but it doesn’t have to be stressful to manage. Take the first step, create a profile, and relax, we will take care of the rest!</p>

              <a class="btn btn-lg btn-info rounded-pill me-2" href="#" role="button">Start Now </a><span> or  </span><a class="btn btn-link ps-1 ps-md-4 ps-lg-1" href="#" role="button"> View Demo ›</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-auto text-center my-4">
              <h1 class="display-3 fw-bold">Social Media Management<br /><span>made simple</span></h1>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 mb-5 mb-md-0"><img class="img-fluid shadow-sm" src="assets/img/gallery/feature-1.png" alt="" />
              <div class="mt-3 text-center text-md-start">
                ...
                <p class="mb-0">If you need attention on your business and want to build brand authority, take the first step!</p><a class="btn btn-link ps-0" href="#" role="button"> Ecommerce Wordpress ›</a>
              </div>
            </div>
            <div class="col-md-4 mb-5 mb-md-0"><img class="img-fluid shadow-sm" src="assets/img/gallery/feature-2.png" alt="" />
              <div class="mt-3 text-center text-md-start">
                <h4 class="display-6 fs-2 fs-lg-3 fw-bold">Register the Business</h4>
                <p class="mb-0">Be ready to checkout the Improved Brand Loyalty of your business in future!.</p><a class="btn btn-link ps-0" href="#" role="button"> Browse Extensions › </a>
              </div>
            </div>
            <div class="col-md-4 mb-5 mb-md-0"><img class="img-fluid shadow-sm" src="assets/img/gallery/feature-3.png" alt="" />
              <div class="mt-3 text-center text-md-start">
                <h4 class="display-6 fs-2 fs-lg-3 fw-bold">& Create the Schedule</h4>
                <p class="mb-0">You just need to create a post creation schedule for your business & boom… Our robots will take care of the rest. </p><a class="btn btn-link ps-0" href="#" role="button"> Check our Forums ›</a>
              </div>
            </div>
          </div>
      ...
      <section class="pt-4 pt-md-5 bg-info">
        <div class="bg-holder" style="background-image:url(assets/img/illustrations/about-bg.png);background-position:center center;background-size:contain;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <div class="row mb-5 text-center">
            <div class="col-12 col-md-4 mb-4"><img class="img-fluid rounded-3 shadow-lg image-up" src="assets/img/gallery/about-2.png" alt="" /></div>
            <div class="col-12 col-md-8 text-md-start" style="max-width: 460px;">
              <h3 class="fw-medium text-light"> Be there, <br />Where yor customers are</h3>
              <p class="text-light">“Social media is like a snowball rolling down the hill. It’s picking up speed. Five years from now, it’s going to be the standard.”.</p><a class="btn btn-lg btn-success rounded-pill" href="#">Read the Documentation</a>
            </div>
          </div>
          <div class="row flex-center">
            <div class="col-12 col-md-4 order-0 order-md-1"><img class="img-fluid rounded-3 shadow-lg image-down" src="assets/img/gallery/about-1.png" alt="" /></div>
            <div class="col-12 col-md-8 text-center text-md-start order-1 order-md-0" style="max-width: 460px;">
              <h3 class="fw-medium text-light">Know the<br />Importance</h3>
              <p class="text-light">"The number-one benefit of social media marketing is standing out in an increasingly noisy world. A significant 88% of all marketers indicated that their social media efforts have generated more exposure for their businesses. Improving traffic and subscribers was the second major benefit, with 72% reporting positive results."</p><a class="btn btn-lg btn-success rounded-pill" href="#">Read the Documentation</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-7 bg-light-gradient">
        <div class="bg-holder" style="background-image:url(assets/img/gallery/testimonial-bg.png);background-position:center center;background-size:contain;">
        </div>
        <!--/.bg-holder-->
                ...
                <div class="carousel-inner overflow-visible">
                  ...
                  <div class="carousel-item z-index-1 active">
                    <div class="card py-4 px-3 py-sm-6 px-sm-5 px-xl-7">
                      <div class="bg-holder mt-4" style="background-image:url(assets/img/gallery/q.png);background-position:center top;background-size:150px;">
                      </div>
                      <!--/.bg-holder-->
                  ...
                  <div class="carousel-item z-index-1">
                    <div class="card py-4 px-3 py-sm-6 px-sm-5 px-xl-7">
                      <div class="bg-holder mt-4" style="background-image:url(assets/img/gallery/q.png);background-position:center top;background-size:150px;height:168px;">
                      </div>
                      <!--/.bg-holder-->
      ...
      <section class="bg-100 pb-0">
        ...
        <div class="position-relative text-center">
          ...
          <!--/.bg-holder-->
          <img class="img-fluid position-relative z-index-1" src="assets/img/gallery/people.png" alt="" />
        </div>
      </section>
      <section class="py-0">
            ...
            <div class="card-body">
              <div class="row flex-center">
                <div class="col-xl-9 d-flex justify-content-center mb-3 mb-xl-0">
                  <h2 class="text-light fw-bold">MitLeaf - the most wanted <br> Reputation Management robot for your business.</h2>
                </div>
          ...
          <div class="row justify-content-lg-around">
            <div class="col-6 col-sm-4 col-lg-auto mb-3 order-0">
              ...
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                ...
                <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Affilate Program</a></li>
              </ul>
            </div>
            <div class="col-6 col-sm-4 col-lg-auto mb-3 order-4 order-lg-1">
              <h6 class="text-light lh-lg text-uppercase"> MitLeaf </h6>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Problem </a></li>
                <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Solution</a></li>
                <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Success Stories</a></li>
                <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Pricing</a></li>

              </ul>
            </div>
            <div class="col-6 col-sm-4 col-lg-auto mb-3 order-1 order-lg-2">
              <h6 class="text-light lh-lg text-uppercase">Other </h6>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
            ...
            <div class="col-6 col-sm-4 col-lg-auto mb-3 order-2 order-lg-4">
              <h6 class="text-light lh-lg text-uppercase">Pages</h6>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Privacy Policy</a></li>
                <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Terms and Conditions</a></li>
                <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Disclaimer</a></li>
                <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Refund Policy</a></li>
              </ul>
            </div>
          </div>
        </div><!-- end of .container-->
            ...
            <div class="col-sm-12 col-md-6 px-md-0 text-md-center order-1 order-md-0">
              <div class="text-400 text-center">
                <p class="mb-0">Made with &nbsp;
                  <svg class="bi bi-suit-heart-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#7854F7" viewBox="0 0 16 16">
                    <path d="M4 1c2.21 0 4 1.755 4 3.92C8 2.755 9.79 1 12 1s4 1.755 4 3.92c0 3.263-3.234 4.414-7.608 9.608a.513.513 0 0 1-.784 0C3.234 9.334 0 8.183 0 4.92 0 2.755 1.79 1 4 1z"></path>
                  </svg>&nbsp;by&nbsp;<a class="text-1000" href="https://flymit.com/" target="_blank">FLYMIT </a>
                </p>
              </div>
            </div>
            <div class="col-sm-12 col-md-3 text-center text-md-end"> <a href="#"><img class="img-fluid" src="assets/img/icons/pf-logo.png" height="14" alt="" /></a></div>
          </div>
        </div><!-- end of .container-->
