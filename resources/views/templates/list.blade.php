<div class="row">
    @foreach($templates as $template)
      <div class="col-12">
        <div class="row my-2 w-100 border">
             ...
             <div class="col-sm-8 px-0">
               ...
               <div class="media p-2 border_b">
                 ...
                 <div class="card_options  p-2">
                   ...
                   <a href="{{ route('templates.show', $template->id) }}" class="btn btn-default btn-sm border_f"><i class="fas fa-image"></i> Show</a>
                   <form class="form-delete col p-1" style="display: unset" method="post" action="{{ route('templates.destroy', $template->id) }}">
                     @method('DELETE')
                     @csrf
                     <button type="submit" class="btn btn-default btn-sm border_f" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i> Delete</button>
                   </form>
                 </div>
