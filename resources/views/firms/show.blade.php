                ...
                <div class="col-md-8 mb-5">
                    ...
                    <div class="card my-2">
                        ...
                        <div class="card_options p-2">
                            <button class="btn btn-default btn-sm border-f" type="button" name="button"><i class="fas fa-sync"></i> Recreate</button>

                            <button class="btn btn-default btn-sm border-f float-right" type="button" name="button"><i class="fas fa-cloud-download-alt"></i> Download</button>
                        </div>
                    </div>
