...
return [
    ...
    */
    ...
    'custom' => [                           // Can be used for any gateway
        'url' => 'http://sms.vndsms.com/vendorsms/pushsms.aspx?',                        // Gateway Endpoint
        'params' => [                       // Parameters to be included in the request
            'send_to_name' => 'msisdn',           // Name of the field of recipient number
            'msg_name' => 'msg',               // Name of the field of Message Text
